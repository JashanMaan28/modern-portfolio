    ...
    <section ref={ref} id="skills" className="relative scroll-mt-24">
      <div className="grid grid-cols-6 gap-6 p-4">
        ...
        >
          ...
          <span className="text-xs font-mono uppercase tracking-wider text-muted-foreground pl-6">Tech Stack</span>
        </div>
          ...
          <div className="flex flex-wrap gap-2">
            {skills.map((skill, index) => (
              <Badge
                ...
                className={`text-xs font-mono font-normal cursor-default
